...
public class InfoPal extends JPanel {
     ...
     * @throws Exception
     */
    public InfoPal(List<String> itemNames,List<JComponent> items,List<JButton> btnCommond,
...
//     */
    ...
    public static void main(String[] args) {
        ...
        try {
            InfoPal pal = new InfoPal(lblItemNames,cptItems,btnCommond,3);
